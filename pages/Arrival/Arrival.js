...
Page({
  data: {
    networkArriveGoodsFun: {},
  },
  onLoad: function(e) {
    var that = this;
    util.networkArriveGoodsFun({
      data: {},
      header: {
      ...
      if (res.data.code == "200") {
        ...
        that.setData({
          networkArriveGoodsFun: data
        });
        if (that.data.networkArriveGoodsFun.allPhProfits) {
          var allPhProfitsList = that.data.networkArriveGoodsFun.allPhProfits;
